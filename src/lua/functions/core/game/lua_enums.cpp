...
void LuaEnums::initReturnValueEnums(lua_State* L) {
	...
	registerEnum(L, RETURNVALUE_NOTENOUGHLUCKLEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHMELEELEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHDEXTERITYLEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHRUNICLEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHDISTANCELEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHDEFENSELEVEL);
	registerEnum(L, RETURNVALUE_NOTENOUGHTONICITYLEVEL);
