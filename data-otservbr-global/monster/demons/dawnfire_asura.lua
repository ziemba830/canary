...
monster.attacks = {
	...
	{ name = "combat", interval = 3700, chance = 17, type = COMBAT_LIFEDRAIN, minDamage = -100, maxDamage = -250, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false },
	{ name = "combat", interval = 3200, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -100, maxDamage = -300, radius = 4, range = 5, target = true, effect = CONST_ME_MORTAREA },
	...
	{ name = "speed", interval = 2000, chance = 15, speedChange = -100, radius = 1, effect = CONST_ME_MAGIC_RED, target = true, duration = 10000 },
}
...
monster.defenses = {
	...
	armor = 48,
	mitigation = 1.46,
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_HEALING, minDamage = 150, maxDamage = 275, effect = CONST_ME_MAGIC_BLUE, target = false },
