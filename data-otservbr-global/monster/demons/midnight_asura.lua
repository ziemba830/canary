...
monster.attacks = {
	...
	{ name = "combat", interval = 3700, chance = 17, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -150, length = 5, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false },
	{ name = "combat", interval = 4100, chance = 27, type = COMBAT_DEATHDAMAGE, minDamage = -100, maxDamage = -250, length = 8, spread = 0, effect = CONST_ME_MORTAREA, target = false },
...
monster.defenses = {
	...
	armor = 55,
	mitigation = 1.60,
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_HEALING, minDamage = 125, maxDamage = 250, effect = CONST_ME_MAGIC_BLUE, target = false },
